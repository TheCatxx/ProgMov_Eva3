...
class BookFragment: Fragment() {
    ...
    private fun registerAlertBook(){
        ...
        mAlertDialog.btnRegisterBook.setOnClickListener{
            ...
            val autorBook = mDialogView.edtAuthorBook.text.toString()
            val generoBook = mDialogView.edtGenderBook.text.toString()
            val editorialBook = mDialogView.edtEditorialBook.text.toString()
            val resumenBook = mDialogView.edtResumeBook.text.toString()

            val book = Book(titleBook, autorBook, generoBook, editorialBook, resumenBook)
